...
class Capture():
    def __init__(self):
        ...
        self._CapturePictureDir         = './QRcode'            #   folder where the data is stored
    ...
    def openCaptureManual(self ,CaptureID ):
        ...
        if self._Capture.isOpened():
            self._Capture.set(cv2.CV_CAP_PROP_FOURCC, cv2.CV_FOURCC('M', 'J', 'P', 'G'))
            self._Capture.set(cv2.CV_CAP_PROP_FPS, 30)
