# 1 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino"
/*********************************************************************************
...
/*HeadFiles*/
//board Headfile
# 32 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2
//GUI HeadFile
# 34 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2

# 36 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2


# 39 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2

//BLE Headfile
# 42 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2
# 43 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2
//humi Sensor Headfile
# 45 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2
//c++ HeadFile
# 47 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino" 2

# 47 "C:\\Users\\qwer1\\Desktop\\array\\sketch_jun19a\\sketch_jun19a.ino"
using namespace std;
...
void OledStandby(){//System Standby GUI
    ...
    u8g2.drawStr(20 -10,25,"System is Working");

    humi = HTS.readHumidity();
    u8g2.drawStr(20 +5,60,"Humi:");
    u8g2.drawStr(20 +50,60,Convert(humi).substr(0,2).c_str());
    u8g2.drawStr(20 +70,60,"%");
...
void OledPrintSeneor(){//Show array sigal
  ...
  u8g2.drawStr(0,25,"U3:");
  u8g2.drawStr(20,25,Convert(ValueU3).substr(0,6).c_str());

  u8g2.drawStr(64,25,"U4:");
  u8g2.drawStr(84,25,Convert(ValueU4).substr(0,6).c_str());

  u8g2.drawStr(0,40,"U5:");
  u8g2.drawStr(20,40,Convert(ValueU5).substr(0,6).c_str());

  u8g2.drawStr(64,40,"U6:");
  u8g2.drawStr(84,40,Convert(ValueU6).substr(0,6).c_str());

  u8g2.drawStr(0,55,"U7:");
  u8g2.drawStr(20,55,Convert(ValueU7).substr(0,6).c_str());

  u8g2.drawStr(64,55,"U8:");
  u8g2.drawStr(84,55,Convert(ValueU8).substr(0,6).c_str());
